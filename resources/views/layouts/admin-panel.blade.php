...
<body>
    ...
    <div class="fixed inset-0 z-20 bg-gray-500 bg-opacity-60 justify-end hidden" id="responsive-menu">
        <div class="flex flex-col gap-3 w-3/4 md:w-5/12 lg:w-1/3 p-10 bg-slate-100 dark:bg-gray-700 rounded-l-xl"
            ...
            <div class="flex flex-col gap-3 w-10/12">
                ...
                <div class="menu-group">
                    ...
                    <a class="group-items" href="{{ url('/new-article') }}"><i class="bi bi-plus-lg mr-1.5"></i>
                        Buat
                        artikel</a>
                    <a class="group-items" href="{{ url('/articles') }}"><i
                            class="bi bi-card-checklist mr-1.5"></i>
                        Kelola artikel</a>
                    <a class="group-items" href="{{ url('/categories') }}"><i class="bi bi-collection mr-1.5"></i>
                        Kelola kategori</a>
                </div>
